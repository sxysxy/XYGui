...
button1.connect(:ON_COMMAND) {|a,b| WinAPI.call("user32", "MessageBox", 0, "You clicked Button1", "wow", 0)}
button2 = XYPushButton.new(app, wnd, {:title => 'Button2'})
button2.connect(:ON_COMMAND) {|a,b| WinAPI.call("user32", "MessageBox", 0, "You clicked Button2", "wow", 0)}
app.mainloop
